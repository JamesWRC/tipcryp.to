...
import { MailIcon, SwitchHorizontalIcon, CashIcon } from '@heroicons/react/solid'
...
export default function TipJarLayout(props) {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 grid justify-items-center ">
    <div className="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                ...
                <button
                  type="button"
                  className="inline-flex items-center w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:col-start-2 sm:text-sm"
                >
                ...
                <button
                  type="button"
                  className="inline-flex items-center mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:col-start-1 sm:text-sm"
                >
                  <SwitchHorizontalIcon className="-ml-1 mr-2 h-5 w-5" aria-hidden="true" />
                  Transactions
                </button>
              </div>
    </div>
